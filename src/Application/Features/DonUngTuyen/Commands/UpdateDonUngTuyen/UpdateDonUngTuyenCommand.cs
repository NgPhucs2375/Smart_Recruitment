...
public class UpdateDonUngTuyenCommandHandler(IApplicationDbContext context) 
    : IRequestHandler<UpdateDonUngTuyenCommand, Response<int>>
{
    public async Task<Response<int>> Handle(UpdateDonUngTuyenCommand request, CancellationToken cancellationToken)
    {
        ...
        return new Response<int>(data: entity.Id, message: "Cập nhật trạng thái đơn ứng tuyển thành công.");
    }
}