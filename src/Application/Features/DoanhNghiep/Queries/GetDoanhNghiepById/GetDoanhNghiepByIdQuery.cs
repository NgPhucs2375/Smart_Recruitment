...
public class GetDoanhNghiepByIdQuery : IRequest<Response<GetAllDoanhNghiepsViewModel>>
{
    public int Id { get; set; }
}

public class GetDoanhNghiepByIdQueryHandler(
    IApplicationDbContext context,
    IMapper mapper)
    : IRequestHandler<GetDoanhNghiepByIdQuery, Response<GetAllDoanhNghiepsViewModel>>
{
    public async Task<Response<GetAllDoanhNghiepsViewModel>> Handle(
        GetDoanhNghiepByIdQuery request,
