...
import type {
  ...
  DuAnItem,
  ChungChiItem,
} from "@/features/tao-cv/types";
import { newId, maskDateVn, isValidVnDate } from "@/features/tao-cv/types";
...
export function CvForm({ data, onChange }: CvFormProps) {
  ...
  return (
    <div className="cv-form-stack">
      {/* 1. Thông tin liên hệ */}
      <div id="cv-section-lien-he" className="cv-form-card scroll-mt-24">
      ...
      <div id="cv-section-kinh-nghiem" className="cv-form-card scroll-mt-24">
      ...
      {/* 3. Học vấn */}
      <div id="cv-section-hoc-van" className="cv-form-card scroll-mt-24">
        <div data-slot="card-header" style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
      ...
      {/* 4. Kỹ năng */}
      <div id="cv-section-ky-nang" className="cv-form-card scroll-mt-24">
        <div data-slot="card-header" style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
      ...
      {/* 5. Dự án */}
      <div id="cv-section-du-an" className="cv-form-card scroll-mt-24">
        <div data-slot="card-header" style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
      ...
      {/* 6. Chứng chỉ */}
      <div id="cv-section-chung-chi" className="cv-form-card scroll-mt-24">
        <div data-slot="card-header" style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
