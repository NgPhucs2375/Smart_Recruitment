...
function DesktopHeaderV2() {
  return (
    <header className="sticky top-0 z-40 flex h-[4.5rem] shrink-0 items-center justify-between gap-4 border-b border-workspace-border/70 bg-workspace-topbar/85 px-4 backdrop-blur-xl supports-[backdrop-filter]:bg-workspace-topbar/70 md:px-8">
...
function MobileHeaderV2() {
  ...
  return (
    <header className="sticky top-0 z-40 flex h-12 shrink-0 items-center justify-between gap-2 border-b border-workspace-border bg-workspace-topbar/95 backdrop-blur supports-[backdrop-filter]:bg-workspace-topbar/60 px-3">
      <SidebarTrigger
        className={cn(
