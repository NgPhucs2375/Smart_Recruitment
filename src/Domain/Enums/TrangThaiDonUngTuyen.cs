namespace Domain.Enums
{
    public enum TrangThaiDonUngTuyen
    {
        ...
        UngVienRutDon = 4,   // Ứng viên chủ động hủy đơn
        PhuHop = 5,           // HR đánh giá phù hợp (mở liên hệ/tiếp cận)
        TuChoi = 6,           // HR đánh giá không phù hợp

        // --- 4. BAD CASE VẬN HÀNH & VÒNG ĐỜI DỮ LIỆU ---
